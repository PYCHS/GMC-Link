...
\begin{itemize}
  ...
  \item A cross-architecture study on three RMOT hosts ($n{=}3$ multi-seed) showing that the module's gain forms a monotone-inverse ordering against a host's native motion ability; the two lower-deficit FlexHook hosts gain little, consistent with the characterization, though as one architecture family on two splits they are not independent confirmations.
