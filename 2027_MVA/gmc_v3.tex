...
\begin{table}[t]
  \centering
  \caption{Per-class HOTA ablation on iKUN ($n{=}5$ seeds); single $\alpha$: $\alpha_{\mathrm{mot}}{=}\alpha_{\mathrm{app}}{=}0.35$ (LOSO). Others $=$ all expressions outside the moving class.}
  \label{tab:ablation}
  \footnotesize
  \setlength{\tabcolsep}{2pt}
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lccc}
