...
%DIF ADD gmc_v3.tex     Sat Sep 19 15:02:14 2026
...
\DIFaddbegin \begin{table}[b]
  ...
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lcc}
    \hline
    Host        & $\alpha_{\mathrm{mot}}$ (moving class) & $\alpha_{\mathrm{oth}}$ (other class) \\
    \hline
    iKUN        & 1.0 & 0.1 \\
    TransRMOT   & 0.7 & 0.5 \\
    FlexHook V1 & 7   & 7   \\
...
\DIFaddbegin \begin{table}[t]
  \centering
  \caption{\DIFaddFL{[changed] }Per-class HOTA ablation on iKUN ($n{=}5$ seeds); single $\alpha$: $\alpha_{\mathrm{mot}}{=}\alpha_{\mathrm{oth}}{=}0.35$ (LOSO). Others $=$ all expressions outside the moving class.}
  \label{tab:ablation}
  \footnotesize
  \setlength{\tabcolsep}{2pt}
  \begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lccc}
...
Despite these promising results, several limitations remain. First, the road-plane homography assumes a flat ground plane. Scenes with steep slopes or uneven terrain fall outside the model's scope. Second, \DIFdelbegin \DIFdel{a keyword classifier decides which weight an expression is associated with. Therefore, a misread expression gets the incorrect fusion weight. %DIF < $14$ of the $126$ direction expressions in Refer-KITTI V1 are treated as appearance. 
