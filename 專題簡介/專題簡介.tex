...
\begin{center}
  \makebox[\textwidth][c]{\includegraphics[width=1.15\textwidth]{framework_new.png}}\\[2pt]
...
\justifying
本研究於 \textbf{Refer-KITTI} 資料集上，對\textbf{三種基礎追蹤架構}進行交叉驗證，以 \textbf{pooled HOTA} 為指標評估融合前後表現。由表一可見，GMC-Link 在 \textbf{3 個架構中有 2 個超越原論文}，且增益穩定：
